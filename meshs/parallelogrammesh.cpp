...
//    Vertex *vr1 = new Vertex(vt1.x(), vt1.y(), vt1.z(), 0, 0);
//    Vertex *vr2 = new Vertex(vt2.x(), vt2.y(), vt2.z(), 1, 0);
//    Vertex *vr3 = new Vertex(vt3.x(), vt3.y(), vt3.z(), 0, 1);
//    addVertex(vr1);
//    addVertex(vr2);
//    addVertex(vr3);
//    Vertex *vr4 = new Vertex(vr2->x(),          vr2->y(), vr2->z(), 1, 0);
//    Vertex *vr5 = new Vertex(vr2->x() + mSlant, vr3->y(), vr1->z(), 1, 1);
//    Vertex *vr6 = new Vertex(vr3->x(),          vr3->y(), vr1->z(), 0, 1);
//    addVertex(vr4);
//    addVertex(vr5);
//    addVertex(vr6);
}
